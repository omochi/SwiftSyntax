...
internal enum SyntaxKind: String, Codable {
  ...
  case structMembers = "StructMembers"
  ...
  public var isType: Bool {
    ...
    case .typeIdentifier: return true
...
extension Syntax {
  ...
  static func make(root: SyntaxData?, data: SyntaxData) -> Syntax {
    ...
    case .structMembers: return StructMembersSyntax(root: root, data: data)
    ...
    case .typeIdentifier: return TypeIdentifierSyntax(root: root, data: data)
